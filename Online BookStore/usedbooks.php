    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="basicExampleNav">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="myupload.php">My Books</a>
                </li>
...
<main>
    ...
    <section class="team-section my-5 ">
        ...
        <div class="row text-center text-md-left">
            ...
            $query="SELECT * from book where expire=0";
...

            {
                $c++;
                $a=$row['book_id'];
                $query1="SELECT left (description , 90) from book where book_id='$a'";
      ...
      <div class=\"avatar mb-md-0 mb-4 mx-4\">
        ...
        <p class=\"grey-text\">".$row1[0]."</p>
							  ...
							  <a class=\"btn btn-secondary btn-rounded\" href='usedbook_detail.php?book_id=".$row['book_id']."'>Show Detail</a>
