        ...
        <div class="col-md-7">
            ...
            <table class="table">
                <?php foreach($row as $key => $value){
                    if($key == "description" || $key == "image" || $key == "category" || $key == "title" || $key == "expire"){
                        continue;
                    }
                    switch($key){
                        case "book_id":
            ...
            <form method="get" action="admin_book_edit.php" class="my-lg-5">
                <input type="hidden" name="book_id" value="<?php echo $book_id;?>">
                <input type="submit" value="Edit" name="cart" class="btn btn-rounded btn-unique">

            </form>
            <form method="get" action="admin_delete.php" class="my-lg-5">
                <input type="hidden" name="book_id" value="<?php echo $book_id;?>">
                <input type="submit" value="Delete" name="cart" class="btn btn-rounded btn-danger">
