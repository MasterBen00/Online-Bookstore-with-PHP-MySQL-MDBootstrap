...
<main>
    ...
    <section class="team-section my-5 ">
        ...
        <div class="row wow fadeInLeft">
            ...
            <div class="col-md-4">
               <a href="myupload_history.php"><button type="button" class="btn btn-info btn-rounded">History</button></a>
      ...
      <div class=\"avatar mb-md-0 mb-4 mx-4\">
        ...
        <p class=\"grey-text\">".$row5[0]."</p>
							...
							<a class=\"btn btn-danger btn-rounded btn-sm\" href='delete.php?book_id=$temp&amp;seller_id=$temp1'>del</a>
